...
from openedx.core.djangoapps.catalog.utils import (
    get_programs_with_type, get_visible_sessions_for_entitlement, get_mock_session_for_entitlement
)
...
def dashboard(request):
    ...
    unfulfilled_entitlement_mock_sessions = {}
    for course_entitlement in course_entitlements:
        ...
        if not available_sessions:
            mock_session = get_mock_session_for_entitlement(course_entitlement)
            unfulfilled_entitlement_mock_sessions[str(course_entitlement.uuid)] = mock_session
    ...
    context = {
        ...
        'unfulfilled_entitlement_mock_sessions': unfulfilled_entitlement_mock_sessions,
