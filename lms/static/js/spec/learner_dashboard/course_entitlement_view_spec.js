define([
    ...
    describe('Course Entitlement View', function() {
        ...
        setupView = function(isAlreadyEnrolled, hasAvailableSessions) {
            ...
            isAlreadyEnrolled = (typeof isAlreadyEnrolled !== 'undefined') ? isAlreadyEnrolled : true;
            hasAvailableSessions = (typeof hasAvailableSessions !== 'undefined') ? hasAvailableSessions : true;
