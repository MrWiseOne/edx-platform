...
def get_mock_session_for_entitlement(entitlement):
    """
    ...
    return available_sessions[0] if available_sessions else (sessions_for_course[0] if sessions_for_course else None)
